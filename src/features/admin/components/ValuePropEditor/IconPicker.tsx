...
interface IconPickerProps {
  ...
  idPrefix: string;
  value: string;
  onChange: (icon: ValuePropIconName) => void;
}
...
export default function IconPicker({
  ...
  return (
    <div>
      ...
      >
        {VALUE_PROP_ICON_NAMES.map((name) => {
          const Icon = valuePropIcon(name);
          ...
          return (
            ...
            >
              ...
              <Icon
                ...
                strokeWidth={1.8}
              />
              <span className="text-xs">{VALUE_PROP_ICON_LABELS[name]}</span>
            </label>
          );
        })}
      </div>
