...
export default function CatalogMenu({
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className={`${PANEL_CONTAINER} py-10`}>
          <div className="flex items-center justify-between border-b border-(--color-border) pb-6">
            <h2 className="font-heading text-4xl text-(--color-dark)">
              Categorías
            </h2>
            <Link
              href="/catalogo"
          ...
          {!categories ? (
            ...
            <div className="grid grid-cols-1 items-start gap-10 pt-8 lg:grid-cols-[280px_1fr]">
                ...
                >
                  {featuredCategories.map((category) => (
                    <CatalogFeaturedCard
                      ...
                      onNavigate={onNavigate}
                      className={
                        featuredCategories.length > 1 ? undefined : "w-72"
                      }
                    />
                  ))}
                </div>
