...
export type ImageByteValidationResult =
  | { ok: true; mimeType: string }
  | { ok: false; error: 'file_too_large' | 'invalid_file_type' | 'mime_mismatch' };

export function validateImageBytes(buffer: Buffer, declaredMimeType: string | null): ImageByteValidationResult {
  ...
  if (declaredMimeType && normalizeImageMimeType(declaredMimeType) !== mimeType) {
